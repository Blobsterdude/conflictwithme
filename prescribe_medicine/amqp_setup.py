...
exchangename="esdclinic"
exchangetype="topic"

channel.exchange_declare(exchange=exchangename, exchange_type=exchangetype, durable=True)

############ queue to send to queue microservice #############
queue_name1 = 'queue'
channel.queue_declare(queue=queue_name1, durable=True)

#bind queue to queue microservice
channel.queue_bind(exchange=exchangename, queue=queue_name1, routing_key='#') 

############ queue to send to medicine inventory microservice #############
queue_name2 = 'medicine'
channel.queue_declare(queue=queue_name2, durable=True)

#bind queue to medicine inventory microservice
channel.queue_bind(exchange=exchangename, queue=queue_name2, routing_key='#') 
